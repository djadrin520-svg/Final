    ...
    <>
          ...
          <div className="flex flex-col items-center gap-12">
            <div className="grid w-full items-center gap-6 lg:grid-cols-[auto_1fr] lg:gap-6">
              ...
              <div className="flex flex-col pt-3 lg:pt-0">
                <p className="w-full text-lg leading-relaxed font-medium italic text-[#FCFCEE] opacity-90 sm:text-xl">
      ...
      <section className="py-24 px-4 bg-muted/30">
        <div className="mx-auto w-full max-w-7xl">
          ...
          <div className="flex flex-col items-stretch gap-6 sm:flex-row sm:flex-nowrap">
            {education.map((item) => (
              <div
                key={item.institution}
                className="card-hover min-w-0 flex-1 shrink-0 bg-card p-6 ring-1 ring-foreground/5"
              >
                <div>
