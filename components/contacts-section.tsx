        ...
        {contacts.map((contact) => {
          ...
          return (
            <a
              ...
              className="group flex items-center justify-center gap-3 px-4 py-2 ring-1 ring-foreground/5 bg-card transition-colors hover:ring-primary/40 flex-1 min-w-0 sm:flex-none"
            >
