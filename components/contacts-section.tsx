        ...
        {contacts.map((contact) => {
          ...
          return (
            <a
              ...
              className="group flex w-full max-w-xs items-center justify-center gap-3 px-4 py-2 ring-1 ring-foreground/5 bg-card transition-colors hover:ring-primary/40"
            >
